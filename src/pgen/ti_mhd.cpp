...
void MeshBlock::InitUserMeshBlockData(ParameterInput *pin)
{
    ...
    SetUserOutputVariableName(7, "bcc1");
    SetUserOutputVariableName(8, "bcc2");
    SetUserOutputVariableName(9, "bcc3");
    return;
}
...
void MeshBlock::UserWorkBeforeOutput(ParameterInput *pin)
{
    ...
    for(int i=is; i<=ie; i++) {
                ...
                user_out_var(7,k,j,i) = pfield->bcc(IB1,k,j,i); // x cell centerd magnetic field
                user_out_var(8,k,j,i) = pfield->bcc(IB2,k,j,i); // y cell centered magnetic field
                user_out_var(9,k,j,i) = pfield->bcc(IB3,k,j,i); // z cell centered magnetic field
    }
    }
    }
}
