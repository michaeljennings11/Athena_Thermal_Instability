...
public:
  ...
  // functions
  void CalcHydroDiffusionFlux(const AthenaArray<Real> &prim, const AthenaArray<Real> &cons,
  AthenaArray<Real> *flx_out, const FaceField &b,
  ...
  void ViscousFlux_aniso(const AthenaArray<Real> &prim, const AthenaArray<Real> &cons,
  ...
  void ThermalFlux_iso(const AthenaArray<Real> &p,const AthenaArray<Real> &c,
                             AthenaArray<Real> *flx);
  void ThermalFlux_aniso(const AthenaArray<Real> &p,const AthenaArray<Real> &c, const FaceField &bf, const AthenaArray<Real> &bcc, AthenaArray<Real> *flx);
